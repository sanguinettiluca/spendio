  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center">
      <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-md w-full max-w-md">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Bienvenido a Spendio</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-6">Iniciá sesión para continuar</p>
